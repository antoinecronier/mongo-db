...
public class main {
	...
	builder.insert(new BasicDBObject("id", 1));
	builder.insert(new BasicDBObject("id", 2));
	builder.insert(new BasicDBObject("id", 3));*/
	...
	/*builder.find(new BasicDBObject("id", 1)).updateOne(new BasicDBObject("$set", new BasicDBObject("x", 2)));
	builder.find(new BasicDBObject("id", 2)).removeOne();
	builder.find(new BasicDBObject("id", 3)).replaceOne(new BasicDBObject("_id", 3).append("x", 4));*/
